package ru.egslava.openglestutorials;
...
public class MyRenderer implements GLSurfaceView.Renderer {
    ...
    public MyRenderer(Context context) {
        mRawTextResourceVertexShader = getRawTextResource(context, R.raw.vertex_shader);
        mRawTextResourcePixelShader = getRawTextResource(context, R.raw.pixel_shader_texture_normals_distance);
